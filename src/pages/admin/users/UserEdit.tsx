...
import { X, Loader2, ShieldCheck, UserCircle } from "lucide-react";
...
const UserEditModal: React.FC<UserEditModalProps> = ({ user, onClose }) => {
  const { isLoading, error, updateUser } = useUserStore();
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40 backdrop-blur-sm">
      <div className="bg-white rounded-[28px] shadow-2xl w-full max-w-lg max-h-[90vh] overflow-y-auto">
        ...
        <div className="flex items-center justify-between px-6 py-5 border-b border-[#F0E8DF]">
          <h2 className="font-black text-[#3E2C23] text-xl">Edit User</h2>
          <button
            onClick={onClose}
